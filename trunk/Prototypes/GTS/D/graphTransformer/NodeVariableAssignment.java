 ...
 *
 *   Oscar
 *   Contents of NodeVariableAssignment
 *   
 *     1. verifyEdges() 
 *     -description: Tests whether the nodes could be 
 *     				 equivalent according to the edges
 *     				 directly connected to them.
 *     -inputs: None.
 *     -output: True if it is possible.
 *     
 *     2. equals()
 *     -description: Tests equality based on the original
 *     				 variable. It makes no difference whether
 *     				 ruleNode has been changed into a constant
 *     				 or not.
 *     -inputs: Another variable asssignment.
 *     -outputs: True if they were the same when created.
 *   
 */
