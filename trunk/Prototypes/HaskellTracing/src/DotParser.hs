...
action_16 (11) = happyShift action_15
...
happyReduction_8 ((HappyAbsSyn7  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 ((happy_var_1,happy_var_4,happy_var_3)
	) `HappyStk` happyRest
...
happyReduction_11 (HappyTerminal (happy_var_3))
	...
	(HappyTerminal (happy_var_1))
	 =  HappyAbsSyn8
		 (if happy_var_1=="label" then happy_var_3 else ""
	)
...
happyReduction_14 ((HappyTerminal (happy_var_5)) `HappyStk`
	_ `HappyStk`
	(HappyTerminal (happy_var_3)) `HappyStk`
	_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn8
		 (if happy_var_3=="label" then happy_var_5 else happy_var_1
	) `HappyStk` happyRest
...
dotParser tks = happyRunIdentity happySomeParser where
