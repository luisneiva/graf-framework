...
/**
 * Converts a UML model (metamodel + model + instance) into a graph in triples-form.
 * 
 * @author Kevin O'Shea
 */
public class UMLToGraph {
	...
	public UMLToGraph(URL metamodelURL) throws ValidityException, ParsingException, IOException {
	...
	public Graph buildGraph(URL modelURL, URL instanceURL) throws ValidityException, ParsingException, IOException {
		graph = new Graph();
